                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: bg,
                            overflow: "hidden",
                            boxShadow: isWatchFrame(f) ? "inset 0 0 24px rgba(0,0,0,0.55), inset 0 0 6px rgba(0,0,0,0.85)" : undefined,
                            transition: SIZE_TRANSITION,
                          }}
                        >
                          {/* Wear OS Authentic Smartwatch Elements */}
                          {isWatchFrame(f) && (
                            <>
                              <div
                                style={{
                              ...
                              {on && (
                                <div
                                  style={{
                                    ...
                                    height: 336,
                                    borderRadius: "50%",
                                    border: `1px dashed ${p.primary}44`,
                                    pointerEvents: "none",
                                    zIndex: 0,
                                  }}
                                />
